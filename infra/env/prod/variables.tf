...
variable "shared_rg_name" {
  type    = string
  default = "fsd-procesos-rg-eus2-prod-001"
}

variable "shared_cae_name" {
  type    = string
  default = "fsd-procesos-cae-eus2-prod-001"
}

variable "shared_kv_name" {
  type    = string
  default = "fsd-proc-kv-eus2-prod-001"
}

variable "shared_acr_name" {
  type    = string
  default = "fsdproceus2prodacr001"
}

variable "shared_umi_name" {
  type    = string
  default = "fsd-procesos-umi-aca-eus2-prod-001"
}
